const translations = {
    es: {
        ...
        "projects.fastergodot.text": "Motor basado en Godot 4.7 y orientado al rendimiento para juegos Forward+ Vulkan en Windows y Linux x86_64.",
    ...
    en: {
        ...
        "projects.fastergodot.text": "A performance-first engine based on Godot 4.7, built for Forward+ Vulkan games on Windows and Linux x86_64.",
    ...
    ja: {
        ...
        "projects.fastergodot.text": "Windows / Linux（x86_64）向けの Forward+ Vulkan ゲーム用に、パフォーマンスを重視した Godot 4.7 ベースのエンジン。",
