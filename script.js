const translations = {
    es: {
        ...
        "hero.eyebrow": "Jon Tamayo · Informático freelance",
        ...
        "hero.proof.location": "Desarrollador full-stack",
        ...
        "projects.audioex.text": "Extensión para Chrome que permite ecualizar, amplificar, comprimir y controlar el audio de cada pestaña, basada en Manifest V3.",
        "projects.fastergodot.text": "Fork de Godot 4.7 orientado al rendimiento para juegos Forward+ Vulkan en Windows y Linux x86_64.",
        ...
        "projects.manuscrito.text": "Aplicación de escritura sin distracciones para Windows, Linux y macOS.",
        "projects.izarravm.text": "Emulador en Rust para Izarra 3000, un potente ordenador personal DOS ficticio de finales de los 90.",
        "projects.link.code": "Código",
        "projects.link.site": "Web",
        "process.kicker": "Forma de trabajar",
        "process.title": "Primero entender. Luego construir.",
        "process.step1.title": "Entender",
        "process.step1.text": "Aterrizamos el problema, los datos disponibles y qué tendría que pasar para que el proyecto merezca la pena.",
        "process.step2.title": "Probar",
        "process.step2.text": "Preparo una primera versión usable para validar la idea antes de invertir más de la cuenta.",
        ...
        "contact.title": "Cuéntame qué web, herramienta o automatización quieres construir.",
    ...
    en: {
        ...
        "nav.contact": "Contact",
        "hero.eyebrow": "Jon Tamayo · Freelance developer",
        ...
        "hero.proof.location": "Full-stack developer",
        ...
        "projects.audioex.text": "Manifest V3 extension for equalizing, boosting, compressing and controlling each Chrome tab's audio.",
        "projects.fastergodot.text": "Performance-first fork of Godot 4.7, built for Forward+ Vulkan games on Windows and Linux x86_64.",
        ...
        "projects.manuscrito.text": "Distraction-free writing app for Windows, Linux and macOS.",
        "projects.izarravm.text": "Rust emulator for the Izarra 3000, a fictional late-90s DOS workstation.",
        ...
        "process.step1.text": "What hurts, what data exists and what outcome would count as success.",
        "process.step2.title": "Test",
        "process.step2.text": "A first usable flow to validate value before turning it into a system.",
        ...
        "contact.title": "Tell me what website, tool or automation you want to build.",
    ...
    ja: {
        ...
        "projects.audioex.text": "Chrome の各タブの音声をイコライザー、増幅、圧縮などで調整できる Manifest V3 拡張機能。",
        "projects.fastergodot.text": "Windows / Linux（x86_64）向けの Forward+ Vulkan ゲーム用に、パフォーマンスを重視した Godot 4.7 のフォーク。",
        ...
        "projects.manuscrito.text": "Windows / Linux / macOS 向けの、集中して書くためのライティングアプリ。",
        "projects.izarravm.text": "1990年代後半の架空の DOS ワークステーション「Izarra 3000」向け Rust 製エミュレータ。",
        "projects.link.code": "コード",
        "projects.link.site": "サイト",
        "process.kicker": "進め方",
