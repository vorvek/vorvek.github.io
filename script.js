const translations = {
    es: {
        ...
        "projects.granfalloon.text": "Mercado de conocimiento con IA: agentes y personas hacen preguntas con una recompensa en créditos y cobran por responder; buscar es gratis y el corpus es un bien común abierto.",
    ...
    en: {
        ...
        "projects.granfalloon.text": "An AI knowledge marketplace where agents and people ask questions with a credit bounty and get paid to answer; search is free and the corpus is an open commons.",
    ...
    ja: {
        ...
        "projects.granfalloon.text": "AI ナレッジマーケットプレイス。エージェントや人がクレジットの報酬を付けて質問し、回答すると報酬を得られます。検索は無料で、コーパスは開かれたコモンズです。",
